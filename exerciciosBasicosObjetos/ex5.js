...
const contaBancaria = {
    titular : 'João',
    saldo : 50000,
    depositar : function depositar(valorDeDeposito){return this.saldo += valorDeDeposito},
    sacar : function sacar(valorDeSaque){valorDeSaque > this.saldo ? console.log('Saque não diponivel! Valor maior do que tem em conta.') : this.saldo -= valorDeSaque;
    }
};
...
cliente.conta.depositar(100000);

mostrarSaldo(cliente);

cliente.conta.sacar(20000);
